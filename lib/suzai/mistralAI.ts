...
9. Utilise le formatage Markdown pour organiser tes réponses :
   - **Gras** pour les titres et points importants
   - *Italique* pour l'emphase
   - Listes à puces pour les étapes et points clés
   - Séparateurs (---) pour diviser les sections
   - Blocs de citation pour les exemples
