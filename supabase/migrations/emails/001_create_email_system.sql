...
-- Comprehensive email management with personal inbox and campaigns
-- =====================================================
...
CREATE TABLE IF NOT EXISTS public.email_folders (
  ...
  folder_path text NOT NULL, -- IMAP path
...
CREATE TABLE IF NOT EXISTS public.personal_emails (
  ...
  recipient_emails text[] NOT NULL, -- Array of recipient emails
  cc_emails text[], -- Array of CC emails
  bcc_emails text[], -- Array of BCC emails
  -- Email content
  email_text text, -- Plain text version
  email_html text, -- HTML version
  -- Status and flags
...
CREATE TABLE IF NOT EXISTS public.email_templates (
  ...
  variables jsonb DEFAULT '{}', -- Available variables like {{firstName}}, {{company}}
...
CREATE TABLE IF NOT EXISTS public.email_unsubscribes (
  ...
  campaign_id uuid, -- Which campaign they unsubscribed from
  reason text,
