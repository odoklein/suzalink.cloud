-- Run this script in your Supabase SQL Editor to fix the tasks table issues
-- This addresses the foreign key constraint violation and missing fields
...
-- 9. Create a function to update project progress when tasks change
...
-- 10. Create triggers to update project progress
